...
QT_MOC_LITERAL(4, 21, 4), // "play"
QT_MOC_LITERAL(5, 26, 8), // "initPlay"
QT_MOC_LITERAL(6, 35, 8), // "initDiff"
QT_MOC_LITERAL(7, 44, 9), // "initAbout"
QT_MOC_LITERAL(8, 54, 8) // "initQuit"

    },
    "MainMenu\0about\0\0diff\0play\0initPlay\0"
    "initDiff\0initAbout\0initQuit"
};
...
void MainMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->initPlay(); break;
        case 4: _t->initDiff(); break;
        case 5: _t->initAbout(); break;
        case 6: _t->initQuit(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::about)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::diff)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MainMenu::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainMenu::play)) {
                *result = 2;
                return;
            }
        }
